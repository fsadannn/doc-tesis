...
En este conjunto de simulaciones, se utilizaran los PVI resultantes de la discretización espacial de cuatro EDP empleadas con frecuencia en la literatura. Estas ecuaciones son: Brusselator 2D (Ejemplo \ref{ex:Brus}), Brusselator 2D (Ejemplo \ref{ex:Brus2D}), Burger's (Ejemplo \ref{ex:Burgers}) y Gray-Scott 2D~(Ejemplo \ref{ex:GS2D}).
