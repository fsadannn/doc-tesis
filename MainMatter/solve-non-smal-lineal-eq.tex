...
La expresión para el error relativo a posteriori de la aproximación libre de Jacobiano se obtiene de forma similar, pero teniendo en cuenta sus propias particularidades. El producto de la matriz particionada $M$ por el vector particionado $u=[u_1,\cdots , u_{l+1}]$ dado por
