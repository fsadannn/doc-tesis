...
\textbf{Proof} Del \ref{theorem:krilobapproxequality}, se tiene
...
\end{align}
y, del Teorema 3.1 en \cite{Naranjo-Noda21}, 
\vspace{-0.25cm}
\begin{equation}
...
\end{equation}
donde $C_{\mf,\kt}^{\pf,\qf}$ está definido en el Teorema 3.1 in \cite{Naranjo-Noda21}.
