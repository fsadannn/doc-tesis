...
\begin{equation*}
	...
	\end{array}\right)
\end{equation*}
de la función vectorial suave 2-dimensional $F(u_1,u_2)=[F_1(u_1,u_2),\,F_2(u_1,u_2)]^T$ para aproximar el producto del Jacobiano por un vector \begin{equation*}
	...
	\end{array}\right],
\end{equation*}
donde $J(u)$ es la matriz Jacobiana de $F$ y $b=[b_1,b_2]^T$ es un vector 2-dimensional. Aproximando $F(u+\delta b)$ con la expansión en serie de Taylor de primer orden en $u$, se tiene
\begin{equation*}
	\frac{F(u+\delta b)-F(u)}{\delta} =  \left(\begin{array}{c}
...
\begin{figure}[ht]
	 \begin{minipage}[l]{0.48\linewidth}
	 	\includegraphics[scale=0.34]{Graphics/l2-v2.eps}
	 \end{minipage}
 	\hfill
	\begin{minipage}[r]{0.48\linewidth}
		\includegraphics[scale=0.34]{Graphics/l3-v2.eps}
	\end{minipage}
