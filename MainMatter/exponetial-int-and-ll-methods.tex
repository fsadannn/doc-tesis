...
es efectiva para calcular exponenciales de matrices relativamente peque\~nas y densas; pero no as\'i para matrices de dimensiones moderadas o grandes \cite{moler2003nineteen}.
...
\section{Productos de funciones phi por vectores}

Como se explicó en la Sección \ref{Sec:IE}, los integradores exponenciales resultan de aproximar las expresiones (\ref{ODE Lines Method}) o (\ref{VCF2}). De ésta manera, típicamante, se obtienen expresiones recursivas que involucran integrales de la forma 
\begin{equation*}
...
Otras definiones comunes de las funciones phi como operador son \cite{Saad92}
